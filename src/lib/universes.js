export const UNIVERSES = {
  ...
  NYSE: {
    ...
    scalping:   ['AAPL','MSFT','NVDA','AMZN','META','GOOGL','AVGO','ORCL','ADBE','QCOM','TXN','INTU','NOW','IBM','ACN','AMD','INTC','NFLX','AMAT','LRCX','MU','MRVL','FTNT','LMT','RTX','NOC','GD','BA','CVX','XOM','FCX','NEM','COP','SLB','OXY','HAL','MPC','NRG','VLO','PSX','V','MA','JPM','BAC','GS','MS','WFC','C','AXP','SCHW','TSLA','CRM','PANW','LLY','PFE','MCD','SBUX','COST','UNH','MRNA','ULTA','NKE','TGT','LEVI','FL','MDLZ','GPS','WDC','STX','MRK'],
    // Swing: mid/large cap, diverse sectors — tech, defense, space, commodities, energy, financials, apparel, pharma, AI infra
    swing:      ['AAPL','MSFT','NVDA','AMZN','META','GOOGL','AVGO','ORCL','ADBE','NOW','INTU','QCOM','TXN','CDNS','SNPS','IBM','ACN','EPAM','CTSH','SAP','AMD','INTC','WDAY','NFLX','AMAT','LRCX','MU','KLAC','MRVL','FTNT','ETN','LMT','RTX','NOC','GD','BA','LHX','LDOS','BAH','AXON','KTOS','AVAV','RKLB','ASTS','LUNR','IRDM','VSAT','BWXT','TDY','CVX','XOM','COP','OXY','EOG','CEG','FCX','NEM','GOLD','ALB','SQM','CCJ','MOS','MP','NRG','VLO','PSX','LNG','WMB','FANG','OKE','KMI','ALAB','LULU','ONON','DECK','RL','TPR','UBER','V','MA','JPM','BAC','GS','WFC','C','AXP','COF','SCHW','BX','ICE','HSBC','TSLA','CRM','PANW','CRWD','COST','UNH','MRNA','PFE','JNJ','ABBV','LLY','NVO','AMGN','GILD','REGN','VRTX','ULTA','NKE','TGT','SBUX','LEVI','FL','MDLZ','GPS','TSM','VRT','WDC','STX','PWR','AMT','ANET','EQIX','BE','NVT','GFS','PSTG','VST','GEV','MPWR','MRK','ISRG','DIS','PYPL','HUBS','PLTR'],
    // Aggressive: high beta, momentum — tech, space, energy, financials, apparel, crypto, quantum, EV, biotech, AI infra
    aggressive: ['TSLA','AMD','NVDA','CRM','SNOW','PLTR','CRWD','NET','DDOG','ZS','PANW','SMCI','ARM','MSTR','PATH','GTLB','MDB','OKTA','AI','SOUN','BBAI','S','WOLF','MRVL','KTOS','AVAV','AXON','RKLB','LUNR','ASTS','JOBY','ACHR','GSAT','RDW','CEG','VST','DVN','FCX','ALB','LAC','UEC','CCJ','DNN','MP','NEM','GOLD','ALAB','SPCX','LULU','CROX','ONON','UBER','COF','LNG','FANG','EQT','COIN','MARA','RIOT','HOOD','SOFI','AFRM','UPST','IONQ','QBTS','RGTI','RIVN','LCID','NIO','BLNK','CHPT','HIMS','CELH','SHOP','RBLX','ROKU','SQ','ABNB','NVAX','MRNA','BIIB','VRTX','BMRN','EXAS','TSM','VRT','PWR','BE','ANET','NVT','PSTG','GFS','GEV','MPWR','APP','NU'],
  },
}
